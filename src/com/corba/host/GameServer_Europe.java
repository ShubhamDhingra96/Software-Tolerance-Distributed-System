...
public class GameServer_Europe extends Thread
{
	 ...
	 * @throws NotFound 
	 */
	private void StartGameServer_Europe() throws InvalidName, ServantAlreadyActive, WrongPolicy, ObjectNotActive, FileNotFoundException, AdapterInactive, ServantNotActive, org.omg.CosNaming.NamingContextPackage.InvalidName, NotFound, CannotProceed 
	{
